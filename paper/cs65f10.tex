...
\begin{quote}
\caption{Example tweet marked as english}
Q chatoñ vou na pré-estreia HP7 mais na sexta eu to la 
\end{quote}
...
\begin{quote}
\caption{Example of relaxed twitter grammar}
...
\hline
 & Emoticon \\
\hline
The Subjectivity Lexicon & good, superb, excellent, want\\
\hline
...
\end{equation}
This indicates that if there were a particularly negative day for a given topic, the daily sentiment score ¿f,¿ would be below 1. We sum over the absolute value of negativeness because negativeness is stored as a negative number.
